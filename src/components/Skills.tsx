    ...
    const skillCategories = [
        {
            ...
            skills: ["Machine Learning", "Deep Learning", "NLP", "PyTorch", "TensorFlow", "LLMs"]
        },
        {
            name: "Développement",
            skills: ["Python", "TypeScript", "React", "Node.js", "SQL", "Git"]
        },
        {
            name: "Sciences Cognitives",
            skills: ["Psychologie Cognitive", "Neurosciences", "UX Research", "Statistiques"]
        },
        {
            name: "Outils & Design",
            skills: ["Figma", "Docker", "Jira", "Latex", "Suite Adobe"]
        }
    ];

    return (
        <section id="competences" className="py-24 w-full container mx-auto px-6 max-w-6xl">
